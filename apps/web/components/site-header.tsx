    ...
    return (
        <header className={cn(
            ...
            <div className="container mx-auto px-4 md:px-8 h-16 flex items-center justify-between gap-4">
                ...
                <div className="flex-1 flex justify-center max-w-sm hidden lg:flex relative mx-4">
                    <Search className="absolute left-3 top-2.5 h-4 w-4 text-gray-500" />
                    <Input
                        type="search"
                        placeholder="공연, 전시장, 인물로 검색해보세요"
                        className="pl-9 w-full bg-gray-100 border-gray-200 focus-visible:ring-1 focus-visible:ring-primary rounded-full transition-all hover:bg-white hover:shadow-sm"
                    />
                </div>
